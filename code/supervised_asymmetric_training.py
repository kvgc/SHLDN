...
from dataloader import train_dataloader as _train_dataloader, dataloader, fetch_filenames, fetch_train_val_filenames, train_val_split
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nonlenses_dataset_size', type=int, default=None)
    parser.add_argument('--lenses_dataset_size', type=int, default=None)
    ...
    logging.info('nonlenses_dataset_size: {}'.format(
        args.nonlenses_dataset_size))
    logging.info("lenses_dataset_size: {}".format(args.lenses_dataset_size))
    ...
    ###################################
    train_filenames, val_filenames = fetch_train_val_filenames(
        'data/{dataset}/DLS'.format(dataset=args.dataset), 'train', args.nonlenses_dataset_size, args.lenses_dataset_size)
    ...
    for epoch in range(args.epochs):
        ...
        train_filenames, _ = fetch_train_val_filenames(
            'data/TrainingV1/DLS', 'train', args.nonlenses_dataset_size, args.lenses_dataset_size)
